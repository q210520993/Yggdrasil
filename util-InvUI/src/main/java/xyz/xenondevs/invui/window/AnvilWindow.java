...
public interface AnvilWindow extends Window {
    ...
    interface Builder<S extends Builder<S>> extends Window.Builder<AnvilWindow, S> {
        ...
        /**
         * A single {@link AnvilWindow} builder. Combines both {@link Builder} and {@link Window.Builder.Single}
        ...
        /**
         * A split {@link AnvilWindow} builder. Combines both {@link Builder} and {@link Double}
