...
//        viewer.getInventory().setCursorItem(outputItem);
    ...
    /**
     * Gets the content {@link Inventory inventories} associated with this
    ...
    public static abstract class AbstractBuilder<W extends Window, S extends Builder<W, S>> implements Builder<W, S> {
